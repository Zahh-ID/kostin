<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('owner.room-types.index') }}" class="text-sm text-gray-600">&larr; {{ __('Cancel') }}</a>
            <h1 class="text-2xl font-semibold mt-2 mb-4">{{ __('Create Room Type') }}</h1>
                ...
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="{{ __('e.g., Single AC, Private Bathroom') }}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Area (m²)') }}</label>
                            <input type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="12">
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="3" placeholder="{{ __('e.g., AC, Wi-Fi, Wardrobe') }}"></textarea>
                        </div>
